 ...
 * @var iterable<\App\Model\Entity\VehicleType> $vehicleTypes
 */
?>
<div class="vehicleTypes index content">
    <?= $this->Html->link(__('New Vehicle Type'), ['action' => 'add'], ['class' => 'button float-right']) ?>
